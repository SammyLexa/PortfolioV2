                ...
                <Grid item xs={12} md={12}>
                    <Box justifyContent={'center'}>
                        <Card sx={{ maxWidth: '100%' }} elevation={24} >
                            <CardMedia
                                sx={{ height: 640 }}
                                image="https://ik.imagekit.io/sammylexa/Grafeat/Grafeat.jpeg?updatedAt=1681572643746"
                                title="Site"
                            />
                ...
                <Grid item xs={12} md={4}>
                    <Box className='card' justifyContent={'center'}>
                        <Card sx={{ maxWidth: '100%' }} elevation={24}>
                            <CardMedia
                                sx={{ height: 240 }}
                                image="https://ik.imagekit.io/sammylexa/Ilustra%C3%A7%C3%B5es_do_blog/blog-inicial.jpg?updatedAt=1681314067858"
                                title="Site"
                            />
                            <CardContent className='card'>
                                <Typography gutterBottom variant="h5" component="div" className='titulo'>
                ...
                <Grid item xs={12} md={4}>
                    <Box className='card' justifyContent={'center'}>
                        <Card sx={{ maxWidth: '100%' }} elevation={24}>
                            <CardMedia
                                sx={{ height: 240 }}
                                image="https://ik.imagekit.io/sammylexa/Grafeat/BannerGra_1__2_.png?updatedAt=1681569211924g"
                                title="green iguana"
                            />
                            <CardContent className='card'>
                                <Typography gutterBottom variant="h5" component="div" className='titulo'>
